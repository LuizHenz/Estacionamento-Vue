    ...
    <div class="container mt-5">
        ...
        <div class="row">
            <div class="col-md-6 text-start">
                ...
                <input type="text" :disabled="form === 'excluir' ? '' : disabled" class="form-control"
            ...
            <div class="col-md-6 text-start">
                ...
                <input type="text" :disabled="form === 'excluir' ? '' : disabled" class="form-control"
                    v-model="configuracao.incioExpediente">
            </div>
            <div class="col-md-6 text-start">
            ...
            <div class="col-md-6 text-start">
                ...
                <input type="text" :disabled="form === 'excluir' ? '' : disabled" class="form-control"
                    placeholder="Valor em horas" v-model="configuracao.tempoParaDesconto">
            </div>
            <div class="col-md-6 text-start">
                <label class="form-label mt-3">Tempo de desconto *</label>
                <input type="text" :disabled="form === 'excluir' ? '' : disabled" class="form-control"
                    placeholder="Valor em horas" v-model="configuracao.tempoDeDesconto">
            </div>
            <div class="row">
                <div class="col-md-6 text-start">
                    <label class="form-label">Gerar desconto*</label>
                    <select v-model="configuracao.gerarDesconto" :disabled="form === 'excluir' ? '' : disabled"
        ...
        <div class="row mt-3">
            <div class="col-md-2 offset-md-4">
                <div class="d-grid gap-2">
                    <router-link type="button" class="btn btn-primary" to="/configuracao-lista">Voltar</router-link>
                </div>
            </div>
            <div class="col-md-2 ">
                <div class="d-grid gap-2">
